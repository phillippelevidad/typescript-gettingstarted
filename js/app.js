...
var Scoreboard = (function () {
    ...
    Scoreboard.prototype.updateScoreboard = function () {
        ...
        for (var i = 0; i < this.results.length; i++) {
            ...
            var currentOutput = "<h4>" + result.playerName + ": " + result.score + "/" + result.problemCount + " for factor " + result.factor + "</h4>";
...
var Game = (function () {
    ...
    Game.prototype.displayGame = function () {
        ...
        for (var i = 1; i <= this.problemCount; i++) {
            ...
            gameForm += "<label for='answer" + i + "' class='col-sm-2 control-label'>" + this.factor + " x " + i + " = </label>";
